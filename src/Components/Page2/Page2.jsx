...
const Page2 = () => {
  ...
  return (
    ...
    <div className='p2'>
      ...
      <div className='heading'>We Are The Company You Can Trust On</div>
      <div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque tempore obcaecati, voluptatem eius veritatis enim cumque. Iusto asperiores ad similique natus ratione ab porro itaque perferendis? Illum suscipit at magnam temporibus praesentium, ex autem harum quas? Nulla at esse beatae excepturi, alias illo optio amet sunt fuga eaque, quam quos. Delectus quis in, facilis unde aperiam corrupti iste? Quia, dolorem vero vitae minima iste, quod optio magni a omnis earum laborum corporis nulla quis non quisquam reiciendis eaque sapiente suscipit nam ab ea ipsa, veniam porro quidem! Nisi impedit eos cum est illum? Expedita, optio quia. Veritatis possimus ex tempore mollitia nisi voluptas magnam corrupti, earum enim expedita adipisci laudantium excepturi quasi ut labore ea temporibus ipsam consequuntur dignissimos debitis praesentium illum? Quod maiores aspernatur consequatur natus soluta accusantium beatae.</div>
      <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, pariatur id aliquam debitis ullam impedit distinctio quos eligendi ex fuga similique atque hic iure delectus explicabo porro nam unde sequi!</div>
    </div>
    ...
    <div className='box'>
        <button className='box2'>What are website<br/> maintenance<br/> services?</button>
        <button className='box2'>How does website<br/> maintenance<br/> work?</button>
        <button className='box2'>What are the <br/>benefits of website <br/>maintenance?</button>
        <button className='box3'>What types of <br/>Maintenance <br/>Services are<br/> available?</button>
        <button className='box2'>How much does <br/>website <br/>maintenance cost?</button>
    </div>
