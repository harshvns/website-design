...
{visibleDiv === 'div2' && (
    <div className='maintenance'>
        <div className='mainten'>
            <p className='heading'>How does website maintenance work?</p>
...
{visibleDiv === 'div3' && (
    <div className='maintenance'>
        <div className='mainten'>
            <p className='heading'>What are the benefits of website maintenance?</p>
...
{visibleDiv === 'div4' && (
    <div className='maintenance'>
        <div className='mainten'>
            <p className='heading'>What types of Maintenance Services are available?</p>
...
{visibleDiv === 'div5' && (
    <div className='maintenance'>
        <div className='mainten'>
            <p className='heading'>How much does website maintenance cost?</p>
