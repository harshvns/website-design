    ...
    <div className='Page3'>
        ...
        <div className='container'>
            <div className='box4'>
                ...
                <p><TiTick /> Compression techniques for fast download</p>
                <p><TiTick /> Get rid of spam comments</p>
            </div>
            <div className='box4'>
                <img className='boximg' width={330} height={330} src={Fixes} alt="" />
            ...
            <p><TiTick /> Consistent plugi update</p>
            <p><TiTick /> Theme update for a fresh experience</p>
            <p><TiTick /> Deleted unused themes and plugins</p>
            <p><TiTick /> Regularly Find & Fix broken links</p>
            </div>
            <div className='box4'>
                <img className='boximg' width={330} height={330} src={Content} alt="" />
            ...
            <p><TiTick /> Add, edit and update content</p>
            <p><TiTick /> Better user experience</p>
            <p><TiTick /> Full-website backup</p>
            <p><TiTick /> Always prepared for disaster</p>
            </div>
            <div className='box4'>
                <img className='boximg' width={330} height={330}  src={Funtionality} alt="" />
                ...
                <p><TiTick /> Team of Passionate Developers</p>
                <p><TiTick /> Hand-Holding Support</p>
                <p><TiTick /> Consultation with Experts as Needed</p>
                <p><TiTick /> Constant monitoring for database errors</p>
            </div>
            <div className='box4'>
                <img className='boximg' width={330} height={330}  src={Tech} alt="" />
                ...
                <p><TiTick /> Clean up logs and database</p>
                <p><TiTick /> Scan and Remove Malware</p>
                <p><TiTick /> Spam and Phishing Prevention</p>
                <p><TiTick /> Debugs chronic issues</p>
            </div>
            <div className='box4'>
                <img className='boximg' width={330} height={330}  src={Hack} alt="" />
                ...
                <p><TiTick /> Automated Security Scan</p>
                <p><TiTick /> Firewall Setup and Virus Protection</p>
            </div>
            <div className='box4'>
                <img className='boximg' width={330} height={330}  src={Mobile} alt="" />
                ...
                <p><TiTick /> Browser caching for Mobile Speed</p>
                <p><TiTick /> GZip Caching Implementation</p>
                <p><TiTick /> Lazy Load for Performance</p>
                <p><TiTick /> Solving Alignment Issues</p>
            </div>
            <div className='box4'>
                <img className='boximg' width={330} height={330}  src={Increase} alt="" />
                ...
                <p><TiTick /> Implement Conversion Friendly</p>
                <p>Change</p>
                <p><TiTick /> Assistant for your Marketing Campaign</p>
                <p><TiTick /> Implementing Third-Party Scripts</p>
                <p><TiTick /> Conversion Consultation as Required</p>
            </div>
            <div className='box4'>
                <img className='boximg' width={330} height={330}  src={Clarity} alt="" />
                ...
                <p><TiTick /> Advanced Performance Report</p>
                <p><TiTick /> Uptime Monitoring Report</p>
                <p><TiTick /> Ticket Insight Report</p>
                <p><TiTick /> Google Analytics Traffic Report</p>
            </div>
        </div>
